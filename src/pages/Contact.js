...
const Kontak = () => {
  ...
  const Kontak = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:5000/kontak', {
        message: message,
        name: name,
        email: email,
        subject: subject,
          ...
          >
            ...
            <div className="row container text-left">
              ...
              <div className="col-lg-8">
                <form onSubmit={Kontak} className="box"
                    ...
                    <div className="col-12">
                      <div className="form-group">
                        <textarea
                          ...
                          placeholder=" Tulis pesan disini" value={message}
                    ...
                    <div className="col-sm-6">
                      <div className="form-group">
                        <input
                          ...
                          type="email"
                          onfocus="this.placeholder = ''"
                          onblur="this.placeholder = 'Enter'" value={email}
                    ...
                    <div className="col-12">
                      <div className="form-group">
                        <input
                          ...
                          placeholder="Subjek" value={subject}
